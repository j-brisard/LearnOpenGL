...
int main()
{
    ...
    Shader cubeShader;
    init_cube(cubeShader, "src/Lighting/Lighting-Maps/shaders/vertexShader.vsh",
              "src/Lighting/Lighting-Maps/shaders/cubeFragmentShader.fsh", cubeVAO);
    //Textures setup
    //Diffuse Map
    ...
    Shader cube2Shader;
    init_cube(cube2Shader, "src/Lighting/Lighting-Maps/shaders/vertexShader.vsh",
              "src/Lighting/Lighting-Maps/shaders/lightSourceFragmentShader.fsh", cube2VAO);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        light_position = glm::vec3(3.0f, 3.0f, 3.0f);

        //CUBE
        cubeShader.use();

        cubeShader.setVec3("lightPos", light_position);
