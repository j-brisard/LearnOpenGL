...
int main()
{
    ...
    Shader cubeShader;
    init_cube(cubeShader, "src/Lighting/Materials/shaders/vertexShader.vsh",
              "src/Lighting/Materials/shaders/cubeFragmentShader.fsh", cubeVAO);

    unsigned int cube2VAO;
    Shader cube2Shader;
    init_cube(cube2Shader, "src/Lighting/Materials/shaders/vertexShader.vsh",
              "src/Lighting/Materials/shaders/lightSourceFragmentShader.fsh", cube2VAO);
