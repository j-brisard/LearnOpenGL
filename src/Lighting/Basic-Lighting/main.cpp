...
int main()
{
    ...
    Shader cubeShader;
    init_cube(cubeShader, "src/Lighting/Basic-Lighting/shaders/vertexShader.vsh",
              "src/Lighting/Basic-Lighting/shaders/cubeFragmentShader.fsh", cubeVAO);

    unsigned int cube2VAO;
    Shader cube2Shader;
    init_cube(cube2Shader, "src/Lighting/Basic-Lighting/shaders/vertexShader.vsh",
              "src/Lighting/Basic-Lighting/shaders/lightSourceFragmentShader.fsh", cube2VAO);
